...
public:
    ...
    void setChannels(unsigned short channels_)
    {
        _channels = channels_;
    }
    ...
    void setBit(unsigned short bit_)
    {
        _bit = bit_;
    }
    ...
    int setData(void *data, unsigned int datasize);

    void setSampleCount(unsigned int samplecount_)
    {
